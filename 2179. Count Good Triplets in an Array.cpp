//Question Link: https://leetcode.com/problems/count-good-triplets-in-an-array/description/

class Solution {
public:void updateSegmentTree(int i, int l, int r, int updateIndex, vector<long long>& segmentTree) {
        if (l == r) {
            segmentTree[i] = 1;
            return;
        }
